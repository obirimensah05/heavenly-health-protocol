...
| --- | --- | --- | --- |
| Private markers, credential paths, home paths, secrets, and traversal fail closed | `tests/test_public_release.py` | Module absent during the compile-time RED run | 14 focused tests passed after implementation |
| Safe environment and container templates are retained | `tests/test_public_release.py` | Two intended false-positive failures | 16 focused tests passed after refinement |
